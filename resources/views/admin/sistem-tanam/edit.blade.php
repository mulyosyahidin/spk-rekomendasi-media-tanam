...
@section('title', 'Edit Data Sistem Tanam')
            ...
            <form action="{{ route('admin.sistem-tanam.update', $sistem_tanam) }}" method="POST">
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-space-between">
                                <h4 class="mb-4 mb-md-0 card-title">Edit Data Sistem Tanam</h4>
                ...
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                        <h4 class="card-title mb-0">Edit Data Sistem Tanam</h4>
                    ...
                    <div class="card-body pt-6 border-top">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="nama" value="{{ old('nama', $sistem_tanam->nama) }}"
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <textarea name="deskripsi"
                                      class="form-control @error('deskripsi') is-invalid @enderror">{{ old('deskripsi', $sistem_tanam->deskripsi) }}</textarea>
                            <!--end::Input-->
