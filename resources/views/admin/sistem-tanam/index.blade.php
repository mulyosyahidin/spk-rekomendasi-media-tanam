...
@section('title', 'Kelola Data Sistem Tanam')
        ...
        <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="d-sm-flex align-items-center justify-space-between">
                            <h4 class="mb-4 mb-md-0 card-title">Kelola Data Sistem Tanam</h4>
            ...
            <div class="card w-100 position-relative overflow-hidden">
                <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                    <h4 class="card-title mb-0">Data Sistem Tanam</h4>

                    <a href="{{ route('admin.sistem-tanam.create') }}" class="btn btn-sm btn-primary">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.setAttribute(`action`,
                            `{{ route('admin.sistem-tanam.destroy', false) }}/${id}`);
                        form.submit();
                    }
                })
            });
