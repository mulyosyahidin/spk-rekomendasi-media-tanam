...
@section('title', 'Kelola Data Tanaman')
        ...
        <div class="col-12">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="d-sm-flex align-items-center justify-space-between">
                            <h4 class="mb-4 mb-md-0 card-title">Kelola Data Tanaman</h4>
            ...
            <div class="card w-100 position-relative overflow-hidden">
                <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                    ...
                    <a href="{{ route('admin.tanaman.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <table
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>{{ $item->nama }}</td>
                                    <td class="text-end">
                                        <a href="{{ route('admin.tanaman.show', $item) }}"
                                           class="btn btn-sm btn-outline-primary">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.tanaman.edit', $item) }}"
                                           class="btn btn-sm btn-outline-primary">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.setAttribute(`action`,
                            `{{ route('admin.tanaman.destroy', false) }}/${id}`);
                        form.submit();
                    }
                })
            });
