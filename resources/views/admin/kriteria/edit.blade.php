                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-space-between">
                                <h4 class="mb-4 mb-md-0 card-title">Edit Data Kriteria</h4>
                ...
                <div class="card w-100 position-relative overflow-hidden">
                    ...
                    <div class="card-body pt-6 border-top">
                        ...
                        <div class="fv-row mb-7">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="nama" value="{{ old('nama', $kriterium->nama) }}"
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select name="jenis" id="jenis"
                                        ...
                                        <option value="benefit" {{ old('jenis', $kriterium->jenis) == 'benefit' ? 'selected' : '' }}>
                                            Benefit
                                        </option>
                                        <option value="cost" {{ old('jenis', $kriterium->jenis) == 'cost' ? 'selected' : '' }}>Cost
                                        </option>
                                    </select>
                                    <!--end::Input-->
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="fv-row mb-7 input">
                                    ...
                                    <div class="input-group">
                                        <!--begin::Input-->
                                        <input type="text" name="bobot" value="{{ old('bobot', $kriterium->bobot) }}"
