...
@section('title', 'Matrix Optimalisasi')
        ...
        <div class="col-12">
            ...
            <div class="card w-100 position-relative overflow-hidden">
                <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                    <h4 class="card-title mb-0">Matrix Optimalisasi</h4>
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.perhitungan.pemeringkatan', $tanaman) }}" class="btn btn-sm btn-outline-primary">
                            Pemeringkatan <i class="ti ti-arrow-right"></i>
                        </a>
                    </div>
                </div>
                <!--begin::Body-->
