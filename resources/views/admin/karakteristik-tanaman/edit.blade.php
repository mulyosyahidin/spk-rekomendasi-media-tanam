...
@section('title', 'Edit Data Karakteristik Tanaman')

@section('content')
    <div class="row">
        <div class="col-12">
            <form action="{{ route('admin.karakteristik-tanaman.update', $tanaman) }}" method="POST">
                @csrf
                @method('PATCH')
                    ...
                    <div class="row align-items-center">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-space-between">
                                <h4 class="mb-4 mb-md-0 card-title">Edit Data Karakteristik Tanaman</h4>
                ...
                <div class="card w-100 position-relative overflow-hidden">
                    <div class="px-4 py-3 border-bottom d-flex justify-content-between">
                        ...
                        <a href="{{ route('admin.karakteristik-tanaman.index') }}" class="btn btn-sm btn-primary">
                    ...
                    <div class="card-body pt-6 border-top">
                        @foreach($dataKriteria as $kriteria)
                            ...
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="form-label" for="nilai-{{ $loop->iteration }}">
