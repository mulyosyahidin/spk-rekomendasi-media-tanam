...
<head>
    ...
    <title>Rekomendasi Media Tanam</title>
        ...
        <div class="container pt-10 pb-17 pt-md-14 text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto mb-5">
                    <h1 class="fs-15 text-uppercase text-muted mb-3">Rekomendasi Media Tanam</h1>
                    <h3 class="display-1 mb-6">
                        Rekomendasi alternatif media tanam dan sistem tanam yang tepat untuk setiap tanaman.
                    </h3>
                </div>
                <!-- /column -->
            </div>
            ...
            <div class="row">
                <div class="col-xl-10 mx-auto">
                    ...
                    <div class="job-list mb-10">
                        <h3 class="mb-4">Tanaman</h3>

                        @foreach($data as $item)
                            <a href="{{ route('rekomendasi-media-tanam.show', $item) }}" class="card mb-1 lift">
