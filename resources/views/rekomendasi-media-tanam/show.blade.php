...
<head>
    ...
    <title>{{ $tanaman->nama }} | Rekomendasi Media Tanam</title>
        ...
        <div class="container pt-10 pb-17 pt-md-14 text-center">
            <div class="row">
                <div class="col-lg-8 mx-auto mb-5">
                    <h1 class="fs-15 text-uppercase text-muted mb-3">{{ $tanaman->nama }}</h1>
                    <h3 class="display-1 mb-6">
                        Rekomendasi media tanam dan sistem tanam untuk {{ $tanaman->nama }}
                    </h3>
                </div>
                <!-- /column -->
            </div>
            ...
            <div class="row">
                <div class="col-lg-10 mx-auto mb-5">
                    <div class="blog single mt-n17">
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <h2 class="h1 mb-3">{{ $tanaman->nama }}</h2>

                                <div class="row gy-3 gx-xl-8">
                                    <div class="col-xl-6">
                                        <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                            @foreach($tanaman->karakteristik->take(ceil($tanaman->karakteristik->count() / 2)) as $karakteristik)
                                                <li>
                                                    <span><i class="uil uil-location-arrow me-1"></i></span>
                                                    <span>{{ $karakteristik->nama }}</span>
                                                    <br>
                                                    <span class="text-muted">
                                                        {{ $tanaman->nilai($karakteristik->pivot->id_kriteria) }}
                                                    </span>
                                                </li>
                                            @endforeach
                                        </ul>
                                    ...
                                    <div class="col-xl-6">
                                        <ul class="icon-list bullet-bg bullet-soft-primary mb-0">
                                            @foreach($tanaman->karakteristik->skip(ceil($tanaman->karakteristik->count() / 2)) as $karakteristik)
                                                <li>
                                                    <span><i class="uil uil-location-arrow me-1"></i></span>
                                                    <span>{{ $karakteristik->nama }}</span>
                                                    <br>
                ...
                <div class="col-10 mx-auto mt-5">
                    <p>
                        ...
                        <b>{{ $tanaman->nama }}</b>. Perhitungan ini dilakukan menggunakan metode MOORA (Multi-Objective Optimization by Ratio Analysis). Kolom angka disisi kanan
                        menunjukkan nilai hasil perhitungan yang diperoleh dari metode MOORA.
                    </p>

                    <p>
                        Perhitungan dilakukan menggunakan {{ $kriteria->count() }} kriteria, yaitu {{ $kriteria->pluck('nama')->join(', ') }}.
                    </p>
                </div>
                ...
                <div class="col-10 mx-auto mt-5">
                    <p>
                        Anda dapat memilih untuk menggunakan metode manapun berdasarkan rekomendasi kami, ketersediaan alat dan bahan serta biaya yang Anda miliki.
                    </p>
                </div>
                <!-- /column -->
            </div>
