...
class PerhitunganUserService
{
     ...
     *
     * @param Perhitungan_user $tanaman
     * @return array
     */
    public function matrixKeputusan(Perhitungan_user $tanaman): array
    {
        $data = [];
        ...
        foreach ($alternatif as $item) {
            ...
            foreach ($kriteria as $item2) {
                $nilai = $item2->nilaiSubKriteria()
                    ...
                    ->where('id_sub_kriteria', $tanaman->karakteristik()->where('id_kriteria', $item2->id)->first()->id_sub_kriteria)
                    ->first()?->bobot;
     ...
     * @return array
     */
    public function matrixNormalisasi(Perhitungan_user $tanaman): array
    {
        $data = [];
     ...
     * @return array
     */
    public function matrixOptimalisasi(Perhitungan_user $tanaman): array
    {
        $data = [];
     ...
     * @return array
     */
    public function pemeringkatan(Perhitungan_user $tanaman): array
    {
        $data = [];
     ...
     * @return array
     */
    public function hasilAkhir(Perhitungan_user $tanaman): array
    {
